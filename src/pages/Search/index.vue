...
export default {
  ...
  beforeMount() {
    ...
    //合并对象
    //再发送请求之前,把接口需要的参数,进行整理
    //(给服务器发送请求之前,整理参数并发送,服务器收到参数进行查询并返回数据)
  ...
  methods: {
    ...
    //删除分类的名字
    //带给服务器的参数可有可无，如果为空也会带给服务器
    //设置为undefined就不会带给服务器，优化
    removeCategoryName() {
      ...
      this.getData()
      //地址栏也需要修改
      //严谨：本意是删除query参数，如果路径中有params参数，不应该把它删除
      //params永远是一个对象，永远为真
